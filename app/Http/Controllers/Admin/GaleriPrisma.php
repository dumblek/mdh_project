...
class GaleriPrisma extends Controller
{
    // Main page
    public function index()
    {
		...
		$data = array(  'title'				=> 'Data Galeri Prisma',
						'galeri'			=> $galeri,
						'kategori_galeri'	=> $kategori_galeri,
                        'content'			=> 'admin/galeri_prisma/index'
                    );
    ...
    public function tambah()
    {
        ...
        $data = array(  'title'             => 'Tambah Foto',
                        'kategori_galeri'   => $kategori_galeri,
                        'content'           => 'admin/galeri_prisma/tambah'
                    );
        return view('admin/layout/wrapper',$data);
    }
    ...
    public function tambah_proses(Request $request)
    {
        ...
        DB::table('galeri')->insert([
            ...
            'id_kategori_galeri'    => $request->id_kategori_galeri,
            'id_user'               => Session()->get('id_user'),
            'judul_galeri'          => $filenamewithextension,
            'isi'                   => $request->isi,
        ...
        return redirect('admin/galeri-prisma')->with(['sukses' => 'Data telah ditambah']);
    }
